...
func (mf *MetadataFsm) Apply(command []byte, index uint64) (resp interface{}, err error) {
	...
	switch cmd.Op {
	case opSyncDeleteDataNode, opSyncDeleteMetaNode, opSyncDeleteVol, opSyncDeleteDataPartition, opSyncDeleteMetaPartition, opSyncDeleteUserInfo,
		opSyncDeleteAKUser, opSyncDeleteVolUser, opSyncDeleteQuota, opSyncDeleteLcNode, opSyncDeleteLcConf, opSyncS3QosDelete, opCRRDelete, opCRRStatusDelete:
